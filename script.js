    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "StreamHive uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0b904c39-e5cb-4322-a792-abdac6e323b3',
                    name: data.name || '',
                    email: data.email || '',
